...
extern const char *aesd_circular_buffer_add_entry(struct aesd_circular_buffer *buffer, const struct aesd_buffer_entry *add_entry); //Changed return type to constant char * as per Assignment 8 requirements
